const productDatabase = {
    "01": {
        ...
        oldPrice: 95000,
        discount: 10,
        mainImage: "../img/book/01-main.jpg",
        thumbnails: [
            "../img/book/01-main.jpg",
            "../img/book/01-main.jpg",
        ],
        sku: "9798217091256",
        ...
        description: `
            Mô tả sản phẩm:
            Lớp Học Tâm Lý Cho Người Hướng Nội.
            <p>Không thể phủ nhận rằng người hướng ngoại có ưu thế vượt trội trong đời sống xã hội, nhưng liệu có phải cứ là người hướng nội thì sẽ thiệt thòi hơn không?</p>
            <p>Câu trả lời là “KHÔNG!”</p>
            <p>Vì tác giả Jaehoon Choi cũng là người hướng nội, và anh đã chứng minh được điều này trong cuốn “<strong>Lớp học tâm lý cho người hướng nội”</strong>của mình.</p>
            <p>Là thạc sĩ chuyên ngành tâm lý xã hội tốt nghiệp từ Đại học Sungkyunkwan, Jaehoon Choi hiện giờ đang điều hành Trung tâm Tâm lý “Mind Forest” - nơi chuyên tổ chức các chương trình chẩn đoán tính cách, điều chỉnh cảm xúc, giải quyết xung đột mối quanate,… Với kinh nghiệm nghiên cứu dày dặn, anh khẳng định nếu người hướng nội hiểu một chút về tâm lý học thì ai cũng có thể thoải mái sống mà không cần cố gắng thay đổi tính cách hoặc từ bỏ thiên hướng tự nhiên.</p>
            <p><strong>"Lớp học tâm lý cho người hướng nội"</strong> giải thích một cách thú vị nhiều lý thuyết tâm lý khác nhau, cung cấp các mẹo hữu ích có thể dễ dàng áp dụng vào cuộc sống, khai thác sâu những bài toán muôn thuở vẫn đã và đang làm khó dễ người hướng nội, qua đó giúp họ thích ứng và hòa nhập với phần đông một cách nhịp nhàng hơn.</p>
        `
    },
    ...
    "02": {
        ...
        description: `
            ...
            <h2>Chúng Ta Ai Chẳng Có Lúc Phát Điên</h2>
            <p><strong>"Chúng ta ai chẳng có lúc phát điên"</strong> là tập hợp những câu chuyện về khó khăn trong các mối quan hệ của cuộc sống mà ai cũng đã hoặc đang phải đối mặt hàng ngày nhưng có thể chưa biết cách vượt qua: người sếp độc hại, cha mẹ khắt khe, người yêu đòi hỏi, bạn bè không hiểu cho tâm tư của chúng ta,... Và hàng loạt những căn bệnh tâm lý xuất hiện trong một xã hội dù tiện nghi được đẩy lên cao nhưng tình cảm giữa con người thì ngày càng xa cách: chứng rối loạn tăng động giảm chú ý, căn bệnh trầm cảm - bóng ma của thời đại, chứng sợ xã hội,...</p>
            <p>Thông qua cuốn sách, tác giả muốn gửi đến thông điệp:<em>“Nếu bạn hiểu chính mình, bạn có thể hiểu những người giống hoặc không giống bạn”</em>. Qua lăng kính cùa một người mắc chứng ADHD đang cố gắng vượt qua những kỳ vọng của các mối quan hệ xung quanh, tác giả mong rằng bạn có thể tìm thấy sự đồng cảm sâu sắc và nhận ra, việc chấp nhận “người thân thiết nhất” - chính bản thân bạn - là chìa khóa để giúp các mối quan hệ xung quanh bạn cải thiện và tốt đẹp hơn.</p>
        `
    },
    ...
    "20": {
        ...
        description: `
            <h1>Mô tả sản phẩm</h1>
            <h2>Di Sản Hồ Chí Minh - Hành Trình Theo Chân Bác (Tái Bản 2021)</h2>
            <p>Hành trình của đoàn làm phim “Hồ Chí Minh – Một hành trình” lần theo hành trình tìm đường cứu nước suốt hơn 30 năm của Bác</p>
            <p>Câu chuyện “ngày ấy” của Bác và chuyện “bây giờ” của đoàn làm phim được xen kẽ, lồng ghép vào nhau, tạo ra độ phong phú, sinh động và hấp dẫn. Vì thế, sách không chỉ lùi về quá khứ cách đây gần một thế kỷ như một bộ phim tài liệu lịch sử, mà còn tua nhanh đến hiện tại để tìm hiểu về những đất nước xa xôi như một phóng sự “thế giới đó đây”. Độc giả sẽ có một chuyến du lịch đến 16 nước và vùng lãnh thổ khắp thế giới để hiểu thêm về đất nước, con người nơi đó, để từ đó hiểu rõ hơn bối cảnh câu chuyện của Bác.</p>
            <p>Với độ từng trải và am hiểu của một người đi rất nhiều, đã từng đi tàu thủy từ vùng biển Caribean đến Hắc Hải, đã từng đi xe lửa xuyên Siberia từ Moskva đến Vladivostok, tác giả chia sẻ được bối cảnh lịch sử và cảm xúc của người xưa trên những dặm đường cứu nước. Ông vừa có cái nhìn thâm trầm, cách tiếp cận và sử dụng thông tin cẩn thận, chỉnh chu của một người có tuổi, vừa có những cảm xúc dạt dào của một người trẻ.</p>
